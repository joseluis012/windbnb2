    ...
    <div>
      {isMobile ? (
        ...
        <div className="filterBox">
          <div onClick={props.handleFilterClose} className="filterMenu"></div>

          <div className="menuBox">
            <div className="menuBoxHeader">
              <div className="menuBoxHeaderInfo">Edit your search</div>
              <div
                className="menuBoxHeaderClose"
              ...
              >
                <div className="guestsBox">
                  ...
                  <div className="guestText">
                    {guests > 0 ? (
                      <div style={{ color: `black` }}>{guests} guests</div>
                    ) : (
                      <div> Add guests</div>
                    )}
                  </div>
            ...
            <div id="lupa" className="lupa" onClick={() => setFilter("search")}>
              <div className="btnSearch" onClick={props.search}>
                <SearchIcon /> Search
              </div>
            </div>
          </div>
